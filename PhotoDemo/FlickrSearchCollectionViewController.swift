...
class FlickrSearchCollectionViewController: UICollectionViewController {
    ...
    func fetchData() {
        ...
        if let url = URL(string: "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=ca8b8b92a3a85a8b1869d3e91e7b79b4&text=Seven+Sisters&per_page=20&format=json&nojsoncallback=1") {
